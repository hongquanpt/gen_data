...
output_folder = "/home/thieugt95/Desktop/ped2/02"  # Folder to save the modified images
...
# Indices of frames to extract, starting from the 5th frame and taking every 5th frame
frame_indices_to_extract = list(range(4, len(frames_list), 5))
