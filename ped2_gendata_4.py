...
background_folder = "/home/thieugt95/code/yolov9/data_ext/gendata/01_background"
gendata_folder = "/home/thieugt95/code/yolov9/data_ext/gendata/01"
conf_threshold = 0.5
tracking_class = 0
    ...
    if (idx + 1) in intervals:
        for track in tracks:
            if track.is_confirmed() and track.track_id == target_track_id:
                ...
                extracted_boxes.append((extracted_box, (x1, y1, x2, y2)))
                break
...
for idx, (extracted_box, (x1, y1, x2, y2)) in enumerate(extracted_boxes):
    ...
    # Resize the extracted box to fit the original dimensions
    resized_box = cv2.resize(extracted_box, (x2 - x1, y2 - y1))
