...
#     image_path = '/home/thieugt95/code/yolov9/data_ext/01_Train/000.jpg'
...
#     axs[2].imshow(output)
#     axs[2].set_title('Inpainted Image')import copy
import cv2
import numpy as np
import torchvision.transforms as T  
from torchvision.io import read_image
...
def main():
    ...
    ######################
    save_path = '/home/thieugt95/Desktop/gendata/01_background/inpainted_image.png'
